...
public class PlayerUI : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        GameManager.Instance.OnCurrentPlayablePlayerTypeChanged += GameManager_OnCurrentPlayableTypeChanged;
    ...
    private void GameManager_OnCurrentPlayableTypeChanged(object sender, EventArgs e)
    {
        UpdateCurrentArrow();
    }
